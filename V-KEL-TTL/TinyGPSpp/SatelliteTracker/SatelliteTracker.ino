...
/*
   ...
   Номера спутников, высота над уровнем моря, азимут и отношение сигнал/шум
   ...
   каждый из которых отслеживает отдельное поле в предложении $GPGSV.

   Для этого требуется использовать SoftwareSerial и предполагается, что у вас есть
   последовательное GPS-устройство со скоростью 9600 бод подключено к контактам 4 (RX) и 3 (TX).
*/
